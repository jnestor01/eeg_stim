...
%             Eyelink('command', 'draw_box %d %d %d %d 15', width/2-50, height/2-50, width/2+50, height/2+50);
        ...
        %if you want to group your trials by condition, you could put the
        %condition codes you will use later here.
        %Eyelink('Message', 'V_TRIAL_GROUPING cond1 cond2 cond3 cond4');
    case 'trialstart'
        %% trial start
